...
public class Colors {
    ...
    public static final int AVERAGE_BLACK = 0;
    /** Integer of average of a white color */
    public static final int AVERAGE_WHITE = 255;
     ...
     */
    public static int getAverageOfColor(int colorRGB) {
     ...
     */
    public static int getColorRGB(int backgroundColor) {
