...
import com.shpp.p2p.cs.sushakov.assignment11.advancedcalculator.mathfunctions.expressions.*;
...
public final class ExpressionParser {
    ...
    public ExpressionParser(List<Token> tokens, Map<String, Double> variablesTable) {
        this.tokens = tokens;
        size = tokens.size();
