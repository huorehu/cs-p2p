...
public abstract class AbstractFinder implements Finder {
    ...
    private ListP2P<Silhouette> silhouetteList;
    ...
    public int findSilhouettes(PreparedImage image) {
        ...
        silhouetteList = new ArrayListP2P<>(Silhouette.class);
    ...
    private int getSilhouettesAmount(ListP2P<Silhouette> silhouetteList) {
        ...
        ListP2P<Silhouette> silhouettes = new ArrayListP2P<>(Silhouette.class);
        ((CollectionP2P) silhouetteList).stream().
        filter(silhouette -> ((Silhouette) silhouette).getAmountPixels() > maxSilhouetteSize * PERCENTAGE_OF_SIZING).
        forEach(silhouette -> silhouettes.add((Silhouette) silhouette));
     ...
     */
    private int getAverageAmountPixels(ListP2P<Silhouette> silhouettes) {
        int result = 0;
     ...
     */
    private int getMaxSilhouetteSize(ListP2P<Silhouette> silhouetteList) {
