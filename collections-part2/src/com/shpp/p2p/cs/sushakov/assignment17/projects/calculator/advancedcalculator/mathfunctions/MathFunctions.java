package com.shpp.p2p.cs.sushakov.assignment17.projects.calculator.advancedcalculator.mathfunctions;
...
public class MathFunctions {
    ...
    private static final MapP2P<String, TokenType> TOKEN_TYPE_MAP;
    /** Set of mathematical functions */
    private static final MapP2P<TokenType, BinaryOperation> BINARY_OPERATIONS;
    /** Set of trigonometric functions */
    private static final MapP2P<TokenType, UnaryOperation> MATH_FUNCTIONS;

    static {
        TOKEN_TYPE_MAP = new HashMapP2P<>();
        ...
        // Binary operations
        BINARY_OPERATIONS = new HashMapP2P<>();
